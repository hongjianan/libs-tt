...
int ClientTest_client(int argc, const char* argv[])
{
	if (5 != argc) {
		fprintf(stderr, "usage: ip port length packets_pers\n");
		return -1;
	}
...
int ClientTest(int argc, const char* argv[])
{
	ClientTest_client(argc, argv);
