...
public:
	...
	void output_period(int bps)
	{
        ...
        LOG_INF("elapsed time:%lf, rx_bytes:%llu rx_packets:%llu, tx_bytes:%llu tx_packets:%llu\n",
    ...
    void output_total()
    {
        ...
        LOG_INF("total elapsed time:%lf, rx_bytes:%llu rx_packets:%llu, tx_bytes:%llu tx_packets:%llu\n",
